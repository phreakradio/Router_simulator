...
#**STRUCTURE**
#	- Declare cost table for router 0
#	- Send table to router 1
#	- Recieve updated table from router 1
#	- Listen for any routers that want to connect
#	- If no further updates, kill myself
...
print ("THIS IS ROUTER 0 BROADCASTING ON 128.235.208.35:1200")

#ROUTER 0 DETAILED COST TABLE
...
tableSUPREME = [costTable,[99, 99, 99, 99],[99, 99, 99, 99],[99, 99, 99, 99]]
