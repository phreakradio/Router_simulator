...
def recieve(temp):
	...
	while True:
		...
		if(UPstatus):						#IF THERE WERE NO UPDATES, IT MEANS THE TABLE IS SETTLED AND WE CAN ALL GO HOME
			break
...
print ("THIS IS ROUTER 1 BROADCASTING ON 128.235.208.35:1200")

#ROUTER 1 DETAILED COST TABLE
...
tableSUPREME = [[99, 99, 99, 99],costTable,[99, 99, 99, 99],[99, 99, 99, 99]]
